...
class WardrobeTest {
    ...
    void testHeightVolumeComparator() {
        ...
        //    int res = Double.compare(w1.getHeight(), w2.getHeight()); // .compare - статический метод в классе дабл
            int res = w1.compareTo(w2); // можно и такой инструмент использовать( значания указаны в классе Wardrobe
