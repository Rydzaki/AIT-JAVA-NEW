...
public class StreamAppl {
    public static void main(String[] args) {
        ...
        numbers.stream() // открыл стрим
                .filter(n -> n > 3) // отбераем числа больше 3
                .peek(n -> System.out.println("peek befor sort: " + n)) // для отлаживания промежуточная печать
        ...
        Stream<Integer> streamInt = Arrays.stream(arr)
                .filter(n -> n > 2)
                .filter(n -> n % 2 == 0) // проверка на четные
        ...
        String str = Arrays.stream(arr) // преобразовали интеджер в стринг
                .sorted()    //сортировкак
                .map(Object::toString) // преобразование
