package home_work.company_3_stream.tests;

import home_work.company_3_stream.dao.Company;
import home_work.company_3_stream.dao.CompanyHashSetImpl;
import home_work.company_3_stream.dao.CompanyStrimImpl;
import home_work.company_3_stream.model.Employee;
import home_work.company_3_stream.model.Manager;
import home_work.company_3_stream.model.SalesManager;
import home_work.company_3_stream.model.Worker;
...
class CompanyImplTest {
    ...
    @BeforeEach
    void setUp() {
        company = new CompanyStrimImpl(5); // создан объект класса CompanyArrayListImpl
        e = new Employee[4];
