...
//        printArr(sity);
//        printMetods("set");
//        System.out.println(sity.set(0, "New York")); // todo ищет элемент и заменяет его на новый
//        printMetods("ensureCapasity");
//        printMetods("lastIndexOf"); // Working
//        System.out.println(sity.lastIndexOf("Madrid"));
//        System.out.println(sity.lastIndexOf("New York")); // todo почему не работает??
//
//
//
//
